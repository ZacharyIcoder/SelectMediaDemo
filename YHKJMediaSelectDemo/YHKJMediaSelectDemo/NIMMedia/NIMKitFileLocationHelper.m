...
//    NSString *userID = [NIMSDK sharedSDK].loginManager.currentAccount;//    [[NSUserDefaults standardUserDefaults] setValue:phoneCodeStr forKey:@"USERLogin_phoneCode"];
//     NSString *userID = [[NSUserDefaults standardUserDefaults] objectForKey:@"WenMingShuo"];
    NSString *userID = @"youhuikeji";
